...
const HeroSlider = () => {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-gradient-to-br from-background to-secondary/30">
      ...
      {/* Floating Elements */}
      <div className="absolute top-20 right-20 w-20 h-20 rounded-full bg-accent/20 animate-float delay-1000"></div>
      <div className="absolute bottom-40 left-20 w-16 h-16 rounded-full bg-primary/20 animate-float delay-2000"></div>
      <div className="absolute top-1/3 right-1/4 w-12 h-12 rounded-full bg-primary-glow/20 animate-float delay-3000"></div>
